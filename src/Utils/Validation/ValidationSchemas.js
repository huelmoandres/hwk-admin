...
export const externalUrlSchema = Yup.string().when("is_external", {
  is: true,
  then: Yup.string().required("External URL is required when is_external is true"),
...
export const watermarkImageSchema = Yup.string().when("watermark", {
  is: true,
  then: Yup.string().required("Watermark Image URL is required when Watermark is true"),
  otherwise: Yup.string().notRequired(),
});
...
export const ifLicenseKeySchema = Yup.string().when("is_licensable", {
  is: true,
  then: Yup.string().required("License Key is required when Licensable is true"),
  otherwise: Yup.string().notRequired(),
});
