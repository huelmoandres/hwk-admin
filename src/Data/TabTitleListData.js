...
export const SettingTabTitleListData = (t) => [
  { title: t("settings:tabs.general"), icon: <RiSettingsLine /> },
...
export const JwelleryTwoProductBannerTitle = [
  { title: "LeftContent" },
  { title: "CenterContent" },
  { title: "RightContent" },
];
...
export const JwelleryThreeOfferBannerTitle = [
  { title: "Banner1" },
  { title: "Banner2" },
  { title: "Banner3" },
];
