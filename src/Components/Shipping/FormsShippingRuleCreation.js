      ...
      {({ values, setFieldValue }) => (
        <Form className="theme-form theme-form-2 mega-form">
          <Row>
            <SimpleInputField
              nameList={[
                { name: "name", title: "Name", placeholder: t("EnterName"), require: "true" },
              ]}
            />
                ...
                nameList={[
                  {
                    ...
                    require: "true",
                    onInput:
                      values["shipping_type"] == "percentage" && values["amount"] > 100
