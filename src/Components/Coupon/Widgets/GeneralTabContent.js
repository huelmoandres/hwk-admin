...
const GeneralTabContent = ({ values, setFieldValue }) => {
  ...
  return (
    <>
      <SimpleInputField
        nameList={[
          { name: "title", require: "true", placeholder: t("EnterTitle") },
          { name: "description", require: "true", placeholder: t("EnterDescription") },
          { name: "code", require: "true", placeholder: t("EnterCode") },
        ]}
      />
          ...
          <div className="input-error" ref={ref}>
            <Row className="mb-0 align-items-center">
              ...
              <Col sm={9} className="calender-box">
                <Input
                  value={dateFormate(values["start_date"], true)}
                  readOnly
                  onClick={() =>
                    setIsComponentVisible((prev) => (prev != "startDate" ? "startDate" : ""))
                  }
                />
            ...
            <Row className="mb-0 align-items-center">
              ...
              <Col sm={9} className="calender-box">
                <Input
                  ...
                  value={dateFormate(values["end_date"], true)}
                  readOnly
                  onClick={() =>
                    setIsComponentVisible((prev) => (prev != "endDate" ? "endDate" : ""))
                  }
                />
                <div className="rdrDateRangePickerWrapper">
