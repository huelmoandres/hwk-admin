...
const RestrictionTabContent = ({ values, setFieldValue, errors }) => {
      ...
      request(
        {
          ...
          params: {
            ...
            is_approved: 1,
            paginate: 15,
            search: customSearch ? customSearch : null,
          },
        },
        router
      ),
  ...
  return (
    <>
      ...
      {values["is_apply_all"] ? (
        <ExcludeProducts productList={productList} setSearch={setSearch} />
      ) : (
        <IncludeProducts productList={productList} setSearch={setSearch} />
      )}
      <SimpleInputField
        nameList={[
          {
