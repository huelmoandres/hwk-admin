      ...
      >
        {({ values, setFieldValue }) => (
          <Form className="row">
            <SimpleInputField
              nameList={[
                { name: "title", placeholder: t("EnterTitle"), title: "Title", require: "true" },
              ]}
            />
            ...
            <SimpleInputField
              nameList={[
                { name: "street", placeholder: "Enter Address", title: "Address", require: "true" },
              ]}
            />
            <SearchableSelectInput
              nameList={[
            ...
            <SimpleInputField
              nameList={[
                { name: "city", title: "City", require: "true", placeholder: "Enter City" },
              ]}
            />
            <SimpleInputField
              nameList={[
            ...
            <div className="ms-auto justify-content-center dflex-wgap save-back-button">
              <Btn
                className="btn-md btn-secondary fw-bold"
                title="Cancel"
                onClick={() => {
                  setModal(false);
                }}
