    ...
    <>
      <div className="product-box">
        ...
        <div className="product-detail">
          ...
          <p>
            They have been linked to a number of health benefits, includingimproved digestion, heart
      ...
      <div className="product-style-1">
        <div className="product-image">
          <div className="label-flex">
            ...
            <button type="button" className="btn p-0 wishlist btn-wishlist notifi-wishlist">
              <RiHeartLine />
            </button>
          </div>
          <a>
      ...
      <div className="product-box product-white-bg">
        ...
        <div className="product-detail position-relative">
          ...
          <div className="d-flex align-items-end justify-content-between position-relative">
            <h6 className="price theme-color m-0">{convertCurrency(5.2)}</h6>
            <div className="add-to-cart-btn-2 addtocart_btn">
              <button
                type="button"
                className="active addcart-button btn btn-add-cart"
                onClick={() => setOpen((prev) => !prev)}
              ></button>
              <div className={`cart_qty qty-box ${open ? "open" : ""}`}>
                <div className="input-group">
      ...
      <div className="product-theme-box">
        ...
        <div className="content-box">
          <div className="top-content">
            ...
            <h6>
              by <a> Natures Basket Mart</a> in <a>Vegetables & Fruits</a>
            </h6>
          ...
          <div className="bottom-content">
            <div>
              <span>8 Sales</span>
              <h5 className="price">{convertCurrency(5.2)}</h5>
            </div>
            <div className="btn-grp">
              <button
                type="button"
                className={`addcart-button btn btn-add-cart ${open ? "active" : ""}`}
                onClick={() => setOpen((prev) => !prev)}
              >
                <RiShoppingCartLine />
              </button>
