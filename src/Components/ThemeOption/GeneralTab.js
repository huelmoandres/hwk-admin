    ...
    <>
      <Row>
        <Col sm="12">
          <FileUploadField
            name="header_logo_id"
            uniquename={values?.options?.logo?.header_logo}
            title={"HeaderLogo"}
            errors={errors}
            id="header_logo_id"
            type="file"
          ...
          <FileUploadField
            ...
            name="footer_logo_id"
            id="footer_logo_id"
            uniquename={values?.options?.logo?.footer_logo}
            title={"FooterLogo"}
            type="file"
            values={values}
            setFieldValue={setFieldValue}
          ...
          <FileUploadField
            errors={errors}
            name="favicon_icon_id"
            title={"FaviconIcon"}
            id="favicon_icon_id"
            type="file"
            values={values}
            setFieldValue={setFieldValue}
            uniquename={values?.options?.logo?.favicon_icon}
            helpertext={getHelperText("16x16px")}
          />
          <SimpleInputField
            nameList={[
              {
                name: "[options][general][site_title]",
                title: "SiteTitle",
                placeholder: t("EnterSiteTitle"),
              },
              {
                name: "[options][general][site_tagline]",
                title: "SiteTagline",
          ...
          <SimpleInputField
            nameList={[
              ...
              {
                name: "[options][general][secondary_color]",
          ...
          <SimpleInputField
            nameList={[
              {
                name: "[options][general][seller_register_url]",
                title: "seller_register_url",
                placeholder: t("Enterseller_register_url"),
              },
            ]}
          />
          ...
          {values?.options?.general?.taglines?.map((val, index) => (
            <SimpleInputField
              ...
              nameList={[
                {
                  name: `[options][general][taglines][${index}]`,
                  title: `Tag Line ${index + 1}`,
