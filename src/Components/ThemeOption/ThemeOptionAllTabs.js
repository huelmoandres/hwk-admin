  ...
  return (
    <Col xl="7" lg="8">
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="2">
          <HeaderTab values={values} setFieldValue={setFieldValue} categoryData={categoryData} />
        </TabPane>
        <TabPane tabId="3">
          <FooterTab
            values={values}
        ...
        <TabPane tabId="4">
          <CollectionProduct values={values} setFieldValue={setFieldValue} />
        </TabPane>
        <TabPane tabId="5">
          <ProductLayout values={values} setFieldValue={setFieldValue} errors={errors} />
        </TabPane>
        <TabPane tabId="6">
        ...
        <TabPane tabId="9">
          <ContactPageTab values={values} setFieldValue={setFieldValue} />
        </TabPane>
        <TabPane tabId="10">
          <ErrorPage values={values} />
        </TabPane>
        <TabPane tabId="11">
          <PopupTab values={values} />
        </TabPane>
        <TabPane tabId="12">
          <SeoTab values={values} setFieldValue={setFieldValue} errors={errors} />
        </TabPane>
      </TabContent>
    </Col>
  );
