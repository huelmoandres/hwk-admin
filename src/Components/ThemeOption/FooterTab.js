      ...
      <Row>
        <Col sm="12">
          ...
          {values["options"]["footer"]?.["footer_style"] === "footer_three" && (
            <SimpleInputField
              nameList={[
                { name: "[options][footer][bg_color]", title: "BackgroundColor", type: "color" },
              ]}
            />
          )}
          <SimpleInputField
            nameList={[
              {
                ...
                type: "textarea",
                title: "FooterContent",
                placeholder: t("EnterFooterAbout"),
              },
              {
          ...
          <SimpleInputField
            nameList={[
              ...
              },
              {
                ...
                title: "PlayStoreUrl",
                placeholder: t("EnterPlayStoreUrl"),
              },
              {
                name: "[options][footer][app_store_url]",
                title: "AppStoreUrl",
                placeholder: t("EnterAppStoreUrl"),
              },
            ]}
          />
          <FileUploadField
              ...
              nameList={[
                {
                  ...
                  type: "textarea",
                  title: "CopyrightText",
                  placeholder: t("EnterCopyrightContent"),
                },
              ]}
            />
          )}
