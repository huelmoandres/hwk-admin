const ThemeOptionSubmit = (values, mutate) => {
  ...
  if (values["serviceImage1"]) {
    values["options"]["seller"]["services"]["service_1"]["image_url"] =
      values["serviceImage1"].original_url;
  } else values["options"]["seller"]["services"]["service_1"]["image_url"] = "";

  if (values["serviceImage2"]) {
    values["options"]["seller"]["services"]["service_2"]["image_url"] =
      values["serviceImage2"].original_url;
  } else values["options"]["seller"]["services"]["service_2"]["image_url"] = "";

  if (values["serviceImage3"]) {
    values["options"]["seller"]["services"]["service_3"]["image_url"] =
      values["serviceImage3"].original_url;
  } else values["options"]["seller"]["services"]["service_3"]["image_url"] = "";

  if (values["serviceImage4"]) {
    values["options"]["seller"]["services"]["service_4"]["image_url"] =
      values["serviceImage4"].original_url;
  ...
  if (values["collection_banner_image"]) {
    values["options"]["collection"]["collection_banner_image_url"] =
      values["collection_banner_image"].original_url;
  ...
  if (values["safe_checkout_image"]) {
    values["options"]["product"]["safe_checkout_image"] =
      values["safe_checkout_image"].original_url;
  ...
  if (values["secure_checkout_image"]) {
    values["options"]["product"]["secure_checkout_image"] =
      values["secure_checkout_image"].original_url;
  ...
  if (values["paymentOptionImage"]) {
    values["options"]["footer"]["payment_option_image_url"] =
      values["paymentOptionImage"].original_url;
  ...
  if (values["content_left_image_url"]) {
    values["options"]["about_us"]["about"]["content_left_image_url"] =
      values["content_left_image_url"].original_url;
  ...
  if (values["content_right_image_url"]) {
    values["options"]["about_us"]["about"]["content_right_image_url"] =
      values["content_right_image_url"].original_url;
  ...
  values["options"]["about_us"]["about"]["futures"]?.forEach((elem, i) => {
    if (values[`futureIcons${i}`]) {
      values["options"]["about_us"]["about"]["futures"][i]["icon"] =
        values[`futureIcons${i}`].original_url;
    } else {
      values["options"]["about_us"]["about"]["futures"][i]["icon"] = "";
    }
  });
  ...
  values["options"]["about_us"]["team"]["members"]?.forEach((elem, i) => {
    if (values[`teamContentImage${i}`]) {
      values["options"]["about_us"]["team"]["members"][i]["profile_image_url"] =
        values[`teamContentImage${i}`].original_url;
    } else {
      values["options"]["about_us"]["team"]["members"][i]["profile_image_url"] = "";
    }
  });
  ...
  values["options"]["about_us"]["testimonial"]["reviews"]?.forEach((elem, i) => {
    if (values[`testimonialReviewImage${i}`]) {
      values["options"]["about_us"]["testimonial"]["reviews"][i]["profile_image_url"] =
        values[`testimonialReviewImage${i}`].original_url;
    } else {
      values["options"]["about_us"]["testimonial"]["reviews"][i]["profile_image_url"] = "";
    }
  });
