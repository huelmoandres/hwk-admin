...
const InputWrapperComponent = (props) => {
  ...
  return (
    <div className="input-error">
      <div
        className={`${props.removeExtraSpace !== "true" ? "mb-4" : ""} ${props.nolabel == "true" ? "form-floating" : "align-items-center row"}`}
      >
        {props.nolabel !== "true" && (
          <Col sm="3">
              ...
              <Row>
                ...
                {props.values["value"].length > 1 && (
                  <Col sm="2" xs="3" className="mt-0 ps-sm-2 ps-0 attribute-remove">
                    <a
                      className="h-100 w-100 cursor-pointer text-danger"
                      onClick={() => props.isremovefield.remove(props.keys)}
                    >
                      {t("Remove")}
                    </a>
                  </Col>
