  ...
  const handleSelect = (item) => {
    if (Array.isArray(values[name])) {
      if (values[name].includes(item[getValuesKey])) {
        setFieldValue(
          name,
          values[name].includes(item[getValuesKey])
            ? values[name].filter((elem) => elem !== item[getValuesKey])
            : values[name]
        );
      } else {
          ...
          <a
            className={`select-btn ${
              Array.isArray(values[name])
                ? values[name]?.includes(item[getValuesKey])
                  ? "selected"
                  : values[name]?.some((data) => data?.id == item[getValuesKey])
                    ? "selected wow"
                    : ""
                : item[getValuesKey] == values[name]
                  ? "selected"
                  : ""
            }`}
