  ...
  return (
    <>
      ...
      <SimpleInputField
        nameList={[
          {
            name: "[values][general][min_order_amount]",
            title: "MinimunOrderAmount",
            placeholder: t("EnterMinOrderAmount"),
            helpertext: "*Please enter the minimum amount required for an order to be processed.",
          },
          {
            name: "[values][general][min_order_free_shipping]",
            type: "number",
            title: "MinimumOrderFreeShipping",
            placeholder: t("EnterMinOrderFreeShipping"),
            helpertext: "*Please enter the minimum order amount for free shipping",
          },
          {
            name: "[values][general][product_sku_prefix]",
            title: "StorePrefix",
            placeholder: t("EnterStorePrefix"),
          },
        ]}
      />
      <SearchableSelectInput
      ...
      <SimpleInputField
        nameList={[
          {
            name: "[values][general][copyright]",
            title: "Copyright",
            placeholder: t("EnterCopyright"),
          },
        ]}
      />
    </>
