...
const EmailTab = ({ values, setFieldValue, errors, touched }) => {
  ...
  return (
    <>
      ...
      <SimpleInputField
        nameList={[
          { name: "email", title: "to_mail", type: "email", placeholder: t("enter_email") },
        ]}
      />
      <button
        type="button"
        name="email"
        disabled={(touched?.email && errors?.email) || !touched?.email}
        title="SendEmail"
      ...
      <div className="instruction-box">
        <div className="instruction-title">
          <h4>Instruction</h4>
          <p style={{ color: "red" }}>
            When setting up your email system (SMTP), make sure to do it carefully. If it's not done
            right, you'll encounter errors when placing orders, registering new users, or sending
            newsletters.
          </p>
        </div>
          ...
          <table className="table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Email the user a One-Time Password (OTP) when they request a password reset.
                </td>
              </tr>
              <tr>
                <td>Signup Welcome</td>
                <td>
                  Send a welcome email with information about the signup bonus or other perks to new
                  users.
                </td>
              </tr>
            </tbody>
          ...
          <table className="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Inform vendors when their withdrawal request has been processed and the status
          ...
          <table className="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Notify admin and vendor when a consumer requests a product return and refund.
                </td>
              </tr>
              <tr>
                <td>Refund Decision</td>
                <td>
                  Inform consumers about the outcome of their refund request (approved or denied).
                </td>
              </tr>
              <tr>
          ...
          <table className="table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Notify admin and vendor if an order remains unprocessed for more than 24 hours.
                </td>
              </tr>
            </tbody>
          </table>
