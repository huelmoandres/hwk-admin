    ...
    >
      {({ values, setFieldValue, errors }) => (
        <Form className="theme-form theme-form-2 mega-form row">
          ...
          <SimpleInputField
            nameList={[
              { name: "name", title: "Name", require: "true", placeholder: t("EnterName") },
            ]}
          />
          <SimpleInputField
            nameList={[
              { name: "email", title: "Email", require: "true", placeholder: t("EnterEmail") },
            ]}
          />
          <div className="country-input mb-4">
            <SimpleInputField
              nameList={[{ name: "phone", title: "Phone", require: "true", type: "number" }]}
            />
