...
const CurrencyForm = ({ updateId, buttonName }) => {
  ...
  const {
    ...
    refetch,
  } = useQuery(["/currency/id"], () => request({ url: `${currency}/${updateId}` }, router), {
    enabled: false,
              ...
              nameList={[
                {
                  ...
                  name: "no_of_decimal",
                  type: "number",
                  placeholder: t("EnterDecimalNumber"),
                },
                {
                  name: "exchange_rate",
                  title: "ExchangeRate",
                  ...
                  helpertext:
                    "*Specify the exchange rate for converting other currencies to US Dollars (USD).",
                },
              ]}
            />
            <SearchableSelectInput
