const ElectronicsThreeSubmitInitialValue = (data) => {
  ...
  return {
    ...
    banner1Image: data?.content?.banner?.main_banner?.image_url
      ? { original_url: data?.content?.banner?.main_banner?.image_url }
      : "",
    banner2Image: data?.content?.banner?.grid_banner_1?.image_url
      ? { original_url: data?.content?.banner?.grid_banner_1?.image_url }
      : "",
    banner3Image: data?.content?.banner?.grid_banner_2?.image_url
      ? { original_url: data?.content?.banner?.grid_banner_2?.image_url }
      : "",
    banner4Image: data?.content?.banner?.grid_banner_3?.image_url
      ? { original_url: data?.content?.banner?.grid_banner_3?.image_url }
      : "",
    ...
    offerBannerImage: data?.content?.offer_banner_1?.image_url
      ? { original_url: data?.content?.offer_banner_1?.image_url }
      : "",
    ...obj,
