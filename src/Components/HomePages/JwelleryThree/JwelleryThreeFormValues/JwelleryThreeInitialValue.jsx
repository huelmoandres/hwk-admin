const JwelleryThreeInitialValue = (data) => {
  ...
  return {
    ...
    productBannerCenterContent1LinkType:
      data?.content?.product_banner?.center_panel?.redirect_link?.link_type || "",
    productBannerCenterContent1Link:
      data?.content?.product_banner?.center_panel?.redirect_link?.link || "",
    ...
    // Image
    productBannerCenterContentImage1: data?.content?.product_banner?.center_panel?.image_url
      ? { original_url: data?.content?.product_banner?.center_panel?.image_url }
      : "",
    offerBanner1Image1: data?.content?.offer_banner?.banner_1?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_1?.image_url }
      : "",
    offerBanner1Image2: data?.content?.offer_banner?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_2?.image_url }
      : "",
    offerBanner1Image3: data?.content?.offer_banner?.banner_3?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_3?.image_url }
      : "",
    mainBannerImage: data?.content?.main_banner?.image_url
      ? { original_url: data?.content?.main_banner?.image_url }
      : "",
