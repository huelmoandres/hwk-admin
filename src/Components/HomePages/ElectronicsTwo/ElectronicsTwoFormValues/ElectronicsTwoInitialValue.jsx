const ElectronicsTwoInitialValue = (data) => {
  ...
  return {
    ...
    homeBanner1Image: data?.content?.home_banner?.banner_1?.image_url
      ? { original_url: data?.content?.home_banner?.banner_1?.image_url }
      : "",
    homeBanner2Image: data?.content?.home_banner?.banner_2?.image_url
      ? { original_url: data?.content?.home_banner?.banner_2?.image_url }
      : "",
    homeBanner3Image: data?.content?.home_banner?.banner_3?.image_url
      ? { original_url: data?.content?.home_banner?.banner_3?.image_url }
      : "",
    ...obj,
