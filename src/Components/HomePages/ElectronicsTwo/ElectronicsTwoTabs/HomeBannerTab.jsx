  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle
        ...
        titleList={ElectronicsTwoHomeBannerTitle}
      />
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          <FileUploadField
            paramsProps={{ mime_type: mediaConfig.image.join(",") }}
            name="homeBanner1Image"
            title="Image"
            id="homeBanner1Image"
            showImage={values["homeBanner1Image"]}
            type="file"
            values={values}
          ...
          <CommonRedirect
            ...
            nameList={{ selectNameKey: "homeBanner1LinkType", multipleNameKey: "homeBanner1Link" }}
            setSearch={setSearch}
          />
        ...
        <TabPane tabId="2">
          <FileUploadField
            paramsProps={{ mime_type: mediaConfig.image.join(",") }}
            name="homeBanner2Image"
            title="Image"
            id="homeBanner2Image"
            showImage={values["homeBanner2Image"]}
            type="file"
            values={values}
            setFieldValue={setFieldValue}
            helpertext={getHelperText("806x670px")}
          ...
          <CommonRedirect
            ...
            productData={productData}
            categoryData={categoryData}
            nameList={{ selectNameKey: "homeBanner2LinkType", multipleNameKey: "homeBanner2Link" }}
            setSearch={setSearch}
          />
        ...
        <TabPane tabId="3">
          <FileUploadField
            paramsProps={{ mime_type: mediaConfig.image.join(",") }}
            name="homeBanner3Image"
            title="Image"
            id="homeBanner3Image"
            showImage={values["homeBanner3Image"]}
            type="file"
            values={values}
            setFieldValue={setFieldValue}
            helpertext={getHelperText("806x670px")}
          ...
          <CommonRedirect
            ...
            productData={productData}
            categoryData={categoryData}
            nameList={{ selectNameKey: "homeBanner3LinkType", multipleNameKey: "homeBanner3Link" }}
            setSearch={setSearch}
          />
