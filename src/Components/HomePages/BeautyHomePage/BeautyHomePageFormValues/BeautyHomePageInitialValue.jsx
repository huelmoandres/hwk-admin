const BeautyHomePageInitialValue = (data) => {
  ...
  return {
    ...
    aboutUsImage: data?.content?.about_us?.image_url
      ? { original_url: data?.content?.about_us?.image_url }
      : "",

    productImage: data?.content?.product_video?.image_url
      ? { original_url: data?.content?.product_video?.image_url }
      : "",
    productVideo: data?.content?.product_video?.video_url
      ? { original_url: data?.content?.product_video?.video_url }
      : "",
    ...obj,
