      ...
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          <FileUploadField
            ...
            name="productBanner3LeftContentImage"
            title="Image"
            id="productBanner3LeftContentImage"
            showImage={values["productBanner3LeftContentImage"]}
            type="file"
            values={values}
          ...
          <CommonRedirect
            ...
            nameList={{
              selectNameKey: "productBanner3LeftContentLinkType",
              multipleNameKey: "productBanner3LeftContentLink",
            }}
            setSearch={setSearch}
          />
