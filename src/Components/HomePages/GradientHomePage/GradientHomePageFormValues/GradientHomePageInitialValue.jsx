const GradientHomePageInitialValue = (data) => {
  ...
  return {
    ...
    parallaxBanner1Image: data?.content?.parallax_banner?.banner_1?.image_url
      ? { original_url: data?.content?.parallax_banner?.banner_1?.image_url }
      : "",
    parallaxBanner2Image: data?.content?.parallax_banner?.banner_2?.image_url
      ? { original_url: data?.content?.parallax_banner?.banner_2?.image_url }
      : "",
