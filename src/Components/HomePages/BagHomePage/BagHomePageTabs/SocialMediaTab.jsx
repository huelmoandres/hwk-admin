    ...
    if (values["content"]["social_media"]["banners"].length > 1) {
      ...
      filterValue?.forEach((elem, i) => {
        ...
        elem?.redirect_link?.link_type &&
          setFieldValue(`socialMediaRedirectLinkType${i}`, elem?.redirect_link?.link_type);
        elem?.redirect_link?.link &&
          setFieldValue(`socialMediaRedirectLink${i}`, elem?.redirect_link?.link);
      });
    }
  };
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    ...
                    <CommonRedirect
                      ...
                      nameList={{
                        selectNameKey: `socialMediaRedirectLinkType${index}`,
                        multipleNameKey: `socialMediaRedirectLink${index}`,
                      }}
                      setSearch={setSearch}
                    />
                    <CheckBoxField
