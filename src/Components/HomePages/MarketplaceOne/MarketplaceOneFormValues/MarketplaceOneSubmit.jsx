...
const MarketplaceOneSubmit = (values, mutate) => {
  ...
  if (values["offerBanner1Image4"]) {
    values["content"]["offer_banner_1"]["banner_4"]["image_url"] =
      values["offerBanner1Image4"].original_url;
  ...
  if (values["productList2Image"]) {
    values["content"]["category_product"]["right_panel"]["product_banner"]["image_url"] =
      values["productList2Image"].original_url;
  ...
  if (values["rightPanelLinkType"]) {
    values["content"]["category_product"]["right_panel"]["product_banner"]["redirect_link"][
      "link_type"
    ] = values["rightPanelLinkType"];
  } else {
    values["content"]["category_product"]["right_panel"]["product_banner"]["redirect_link"][
      "link_type"
    ] = "";
  ...
  if (values["rightPanelProduct"]) {
    values["content"]["category_product"]["right_panel"]["product_category"]["category_ids"] =
      values["rightPanelProduct"];
  }
