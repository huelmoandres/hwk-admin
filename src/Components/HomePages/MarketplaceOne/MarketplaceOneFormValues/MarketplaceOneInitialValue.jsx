const MarketplaceOneInitialValue = (data) => {
  ...
  return {
    ...
    offerBanner1Image3: data?.content?.offer_banner_1?.banner_3?.image_url
      ...
      : "",
    offerBanner1Image4: data?.content?.offer_banner_1?.banner_4?.image_url
      ? { original_url: data?.content?.offer_banner_1?.banner_4?.image_url }
      : "",
    ...
    featuredBannerImage: data?.content?.featured_banners?.image_url
      ? { original_url: data?.content?.featured_banners?.image_url }
      : "",

    productList2Image: data?.content?.category_product?.right_panel?.product_banner?.image_url
      ? { original_url: data?.content?.category_product?.right_panel?.product_banner?.image_url }
      : "",
    ...
    rightPanelLinkType:
      data?.content?.category_product?.right_panel?.product_banner?.redirect_link?.link_type || "",
    rightPanelLink:
      data?.content?.category_product?.right_panel?.product_banner?.redirect_link?.link || "",
