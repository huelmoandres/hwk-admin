...
const MarketplaceThreeSubmit = (values, mutate) => {
  ...
  if (values["categoryLeftContentBannerImage"]) {
    values["content"]["categories_products"]["left_panel"]["banner"]["image_url"] =
      values["categoryLeftContentBannerImage"].original_url;
  } else values["content"]["categories_products"]["left_panel"]["banner"]["image_url"] = "";

  if (values["categoryProductOfferBanner1Image"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
      "image_url"
    ] = values["categoryProductOfferBanner1Image"].original_url;
  } else
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
      "image_url"
    ] = "";
  ...
  if (values["categoryProductOfferBanner2Image"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
      "image_url"
    ] = values["categoryProductOfferBanner2Image"].original_url;
  } else
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
      "image_url"
    ] = "";
  ...
  if (values["categoryLeftContentBannerLinkType"]) {
    values["content"]["categories_products"]["left_panel"]["banner"]["redirect_link"]["link_type"] =
      values["categoryLeftContentBannerLinkType"];
  } else {
    values["content"]["categories_products"]["left_panel"]["banner"]["redirect_link"]["link_type"] =
      "";
  ...
  if (values["categoryLeftContentBannerLink"]) {
    values["content"]["categories_products"]["left_panel"]["banner"]["redirect_link"]["link"] =
      values["categoryLeftContentBannerLink"];
    if (values["categoryLeftContentBannerLinkType"] == "product") {
      values["content"]["categories_products"]["left_panel"]["banner"]["redirect_link"][
        "product_ids"
      ] = values["categoryLeftContentBannerLink"];
    } else {
      values["content"]["categories_products"]["left_panel"]["banner"]["redirect_link"][
  ...
  if (values["categoryProductOfferBanner1LinkType"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
      "redirect_link"
    ]["link_type"] = values["categoryProductOfferBanner1LinkType"];
  } else {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
      "redirect_link"
    ]["link_type"] = "";
  ...
  if (values["categoryProductOfferBanner1Link"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
      "redirect_link"
    ]["link"] = values["categoryProductOfferBanner1Link"];
    if (values["categoryProductOfferBanner1LinkType"] == "product") {
      values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
        "redirect_link"
      ]["product_ids"] = values["categoryProductOfferBanner1Link"];
    } else {
      values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"][
        "redirect_link"
      ]["product_ids"] = "";
  ...
  if (values["categoryProductOfferBanner2LinkType"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
      "redirect_link"
    ]["link_type"] = values["categoryProductOfferBanner2LinkType"];
  } else {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
      "redirect_link"
    ]["link_type"] = "";
  ...
  if (values["categoryProductOfferBanner2Link"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
      "redirect_link"
    ]["link"] = values["categoryProductOfferBanner2Link"];
    if (values["categoryProductOfferBanner2LinkType"] == "product") {
      values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
        "redirect_link"
      ]["product_ids"] = values["categoryProductOfferBanner2Link"];
    } else {
      values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"][
        "redirect_link"
      ]["product_ids"] = "";
  ...
  if (values["categoryLeftContentCategories"]) {
    values["content"]["categories_products"]["left_panel"]["categories"]["category_ids"] =
      values["categoryLeftContentCategories"];
  }

  if (values["categoryLeftContentProducts"]) {
    values["content"]["categories_products"]["left_panel"]["products_list"]["product_ids"] =
      values["categoryLeftContentProducts"];
  }

  if (values["categoryRightContentProduts"]) {
    values["content"]["categories_products"]["right_panel"]["products_list"]["product_ids"] =
      values["categoryRightContentProduts"];
  }
