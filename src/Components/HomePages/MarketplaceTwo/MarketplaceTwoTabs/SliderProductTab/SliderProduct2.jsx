          ...
          <>
            <div className="rule-edit-form">
              <SimpleInputField
                nameList={[
                  {
                    name: "[content][slider_products][product_slider_3][title]",
              ...
              />
              <CheckBoxField
                name="[content][slider_products][product_slider_3][status]"
                title="Status"
              />
            </div>
          </>
          ...
          <>
            <div className="rule-edit-form">
              <SimpleInputField
                nameList={[
                  {
                    name: "[content][slider_products][product_slider_4][title]",
                    placeholder: t("EnterTitle"),
                    title: "Title",
                  },
                ]}
              ...
              />
              <CheckBoxField
                name="[content][slider_products][product_slider_4][status]"
                title="Status"
              />
            </div>
          </>
