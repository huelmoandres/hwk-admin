const FurnitureTwoInitialValue = (data) => {
    ...
    data?.content?.grid_banner?.banners?.forEach((elem, index) => {
      {
        index != 0
          ? elem.image_url
            ? (obj[`gridBannerImage${index}`] = { original_url: elem.image_url })
            : ""
          : elem.image_url
            ? (obj[`gridBannerImage${index}`] = { original_url: elem.video_url })
            : "";
      }
      elem?.redirect_link
        ? (obj[`gridBannerRedirectLinkType${index}`] = elem?.redirect_link?.link_type)
        : "";
      elem?.redirect_link
        ? (obj[`gridBannerRedirectLink${index}`] = elem?.redirect_link?.link)
        : "";
      return obj;
    });
  ...
  data?.content?.social_media?.banners?.length > 0 &&
    data?.content?.social_media?.banners?.forEach((elem, index) => {
      elem.image_url
        ...
        : "";
      elem?.redirect_link
        ? (obj[`socialMediaBannerRedirectLinkType${index}`] = elem?.redirect_link?.link_type)
        : "";
      elem?.redirect_link
        ? (obj[`socialMediaBannerRedirectLink${index}`] = elem?.redirect_link?.link)
        : "";
      return obj;
    });
  ...
  return {
    ...
    productList2Banner1Image: data?.content?.product_list_2?.products?.product_banner?.banner_1
      ?.image_url
      ? {
          original_url:
            data?.content?.product_list_2?.products?.product_banner?.banner_1?.image_url,
        }
      : "",
    productList2Banner2Image: data?.content?.product_list_2?.products?.product_banner?.banner_2
      ?.image_url
      ? {
          original_url:
            data?.content?.product_list_2?.products?.product_banner?.banner_2?.image_url,
        }
      : "",
    ...
    productList2Banner1RedirectLinkType:
      data?.content?.product_list_2?.products?.product_banner?.banner_1?.redirect_link?.link_type ||
      "",
    productList2Banner1RedirectLink:
      data?.content?.product_list_2?.products?.product_banner?.banner_1?.redirect_link?.link || "",

    productList2Banner2RedirectLinkType:
      data?.content?.product_list_2?.products?.product_banner?.banner_2?.redirect_link?.link_type ||
      "",
    productList2Banner2RedirectLink:
      data?.content?.product_list_2?.products?.product_banner?.banner_2?.redirect_link?.link || "",
