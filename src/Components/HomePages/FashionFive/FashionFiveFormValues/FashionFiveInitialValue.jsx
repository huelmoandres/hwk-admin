const FashionFiveInitialValue = (data) => {
  ...
  data?.content?.social_media?.banners?.length > 0 &&
    data?.content?.social_media?.banners?.forEach((elem, index) => {
      elem.image_url
        ...
        : "";
      elem?.redirect_link
        ? (obj[`socialMediaLinkType${index}`] = elem?.redirect_link?.link_type)
        : "";
  ...
  return {
    ...
    mainBannerImage: data?.content?.knockout_deals?.main_banner?.image_url
      ? { original_url: data?.content?.knockout_deals?.main_banner?.image_url }
      : "",
    gridBanner1Image: data?.content?.knockout_deals?.grid_banner_1?.image_url
      ? { original_url: data?.content?.knockout_deals?.grid_banner_1?.image_url }
      : "",
    gridBanner2Image: data?.content?.knockout_deals?.grid_banner_2?.image_url
      ? { original_url: data?.content?.knockout_deals?.grid_banner_2?.image_url }
      : "",
    gridBanner3Image: data?.content?.knockout_deals?.grid_banner_2?.image_url
      ? { original_url: data?.content?.knockout_deals?.grid_banner_3?.image_url }
      : "",
    ...obj,
    ...
    gridBanner1LinkType:
      data?.content?.knockout_deals?.grid_banner_1?.redirect_link?.link_type || "",
    gridBanner1Link: data?.content?.knockout_deals?.grid_banner_1?.redirect_link?.link || "",

    gridBanner2LinkType:
      data?.content?.knockout_deals?.grid_banner_2?.redirect_link?.link_type || "",
    gridBanner2Link: data?.content?.knockout_deals?.grid_banner_2?.redirect_link?.link || "",

    gridBanner3LinkType:
      data?.content?.knockout_deals?.grid_banner_3?.redirect_link?.link_type || "",
