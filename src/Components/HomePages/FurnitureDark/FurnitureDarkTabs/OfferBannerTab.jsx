      ...
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          ...
          <SimpleInputField
            nameList={[
              {
                name: `[content][offer_banner][banner_1][title]`,
                placeholder: t("EnterTag"),
                title: "Tag",
              },
              {
                name: `[content][offer_banner][banner_1][sub_title]`,
        ...
        <TabPane tabId="2">
          ...
          <SimpleInputField
            nameList={[
              {
                name: `[content][offer_banner][banner_2][title]`,
                placeholder: t("EnterTag"),
                title: "Tag",
              },
              {
                name: `[content][offer_banner][banner_2][sub_title]`,
                placeholder: t("EnterTitle"),
                title: "Title",
              },
            ]}
        ...
        <TabPane tabId="3">
          ...
          <SimpleInputField
            nameList={[
              {
                name: `[content][offer_banner][banner_3][title]`,
                placeholder: t("EnterTag"),
                title: "Tag",
              },
              {
                name: `[content][offer_banner][banner_3][sub_title]`,
                placeholder: t("EnterTitle"),
                title: "Title",
              },
            ]}
