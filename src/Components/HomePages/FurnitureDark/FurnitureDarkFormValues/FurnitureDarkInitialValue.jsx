const FurnitureDarkInitialValue = (data) => {
  ...
  return {
    ...
    banner1Image: data?.content?.banner?.banner_1?.image_url
      ? { original_url: data?.content?.banner?.banner_1?.image_url }
      : "",
    banner2Image: data?.content?.banner?.banner_2?.image_url
      ? { original_url: data?.content?.banner?.banner_2?.image_url }
      : "",
    banner3Image: data?.content?.banner?.banner_3?.image_url
      ? { original_url: data?.content?.banner?.banner_3?.image_url }
      : "",

    leftPanelImage: data?.content?.product_list_2?.left_panel?.image_url
      ? { original_url: data?.content?.banner?.banner_3?.image_url }
      : "",
