const JwelleryTwoInitialValue = (data) => {
  ...
  data?.content?.offer_banner_1?.banners?.length > 0 &&
    data?.content?.offer_banner_1?.banners?.forEach((elem, index) => {
      ...
      elem?.redirect_link
        ? (obj[`offerBanner1RedirectLinkType${index}`] = elem?.redirect_link?.link_type)
        : "";
      elem?.redirect_link
        ? (obj[`offerBanner1RedirectLink${index}`] = elem?.redirect_link?.link)
        : "";
      return obj;
    });
  ...
  return {
    ...
    productBannerCenterContent1LinkType:
      data?.content?.product_banner?.center_panel?.banner_1?.redirect_link?.link_type || "",
    productBannerCenterContent1Link:
      data?.content?.product_banner?.center_panel?.banner_1?.redirect_link?.link || "",

    productBannerCenterContent2LinkType:
      data?.content?.product_banner?.center_panel?.banner_2?.redirect_link?.link_type || "",
    productBannerCenterContent2Link:
      data?.content?.product_banner?.center_panel?.banner_2?.redirect_link?.link || "",

    // Image
    banner1Image: data?.content?.banner?.image_url
      ? { original_url: data?.content?.banner?.image_url }
      : "",
    offerBanner2Image: data?.content?.offer_banner_2?.image_url
      ? { original_url: data?.content?.offer_banner_2?.image_url }
      : "",
    productBannerCenterContentImage1: data?.content?.product_banner?.center_panel?.banner_1
      ?.image_url
      ? { original_url: data?.content?.product_banner?.center_panel?.banner_1?.image_url }
      : "",
    productBannerCenterContentImage2: data?.content?.product_banner?.center_panel?.banner_2
      ?.image_url
      ? { original_url: data?.content?.product_banner?.center_panel?.banner_2?.image_url }
      : "",
