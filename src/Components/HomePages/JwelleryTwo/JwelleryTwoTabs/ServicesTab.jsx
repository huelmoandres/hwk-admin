    ...
    <>
      {
        <Btn
          ...
          onClick={() =>
            setFieldValue("[content][services][banners]", [
              ...values["content"]?.["services"]["banners"],
              { title: "", description: "" },
            ])
          }
          title="AddBanner"
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    <SimpleInputField
                      nameList={[
                        {
                          name: `[content][services][banners][${index}][title]`,
                          placeholder: t("EnterTitle"),
                          title: "Title",
                        },
                        {
                          name: `[content][services][banners][${index}][description]`,
                    ...
                    <FileUploadField
                      ...
                      helpertext={getHelperText("60x60px")}
                    />
                    <CheckBoxField
                      name={`[content][services][banners][${index}][status]`}
                      title="Status"
                    />
                  </div>
                )}
