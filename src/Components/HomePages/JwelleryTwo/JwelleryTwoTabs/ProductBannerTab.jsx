  ...
  return (
    <div className="inside-horizontal-tabs">
      ...
      <TabTitle
        ...
        titleList={JwelleryTwoProductBannerTitle}
      />
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          <SimpleInputField
            nameList={[
              {
                name: `[content][product_banner][left_panel][title]`,
        ...
        <TabPane tabId="2">
          ...
          <FileUploadField
            ...
            name="productBannerCenterContentImage1"
            title="Image"
            id="productBannerCenterContentImage1"
            showImage={values["productBannerCenterContentImage1"]}
            type="file"
            values={values}
          ...
          <CommonRedirect
            ...
            nameList={{
              selectNameKey: "productBannerCenterContent1LinkType",
              multipleNameKey: "productBannerCenterContent1Link",
            }}
            setSearch={setSearch}
          />
          <CheckBoxField
            name={`[content][product_banner][center_panel][banner_1][status]`}
            title="Status"
          />
          <h4 className="fw-semibold mb-3 txt-primary w-100">{t("Banner2")}</h4>
          <FileUploadField
            paramsProps={{ mime_type: mediaConfig.image.join(",") }}
            name="productBannerCenterContentImage2"
            title="Image"
            id="productBannerCenterContentImage2"
            showImage={values["productBannerCenterContentImage2"]}
            type="file"
            values={values}
            setFieldValue={setFieldValue}
            helpertext={getHelperText("806x670px")}
          ...
          <CommonRedirect
            ...
            categoryData={categoryData}
            nameList={{
              selectNameKey: "productBannerCenterContent2LinkType",
              multipleNameKey: "productBannerCenterContent2Link",
            }}
            setSearch={setSearch}
          />
          <CheckBoxField
            name={`[content][product_banner][center_panel][banner_2][status]`}
            title="Status"
          />
        </TabPane>
        <TabPane tabId="3">
          <SimpleInputField
            nameList={[
              {
                name: `[content][product_banner][right_panel][title]`,
                placeholder: t("EnterTitle"),
                title: "Title",
              },
            ]}
