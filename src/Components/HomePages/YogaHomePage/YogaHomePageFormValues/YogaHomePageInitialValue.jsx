const YogaHomePageInitialValue = (data) => {
  ...
  return {
    ...
    productBanner1Image: data?.content?.product_banner?.post_banner?.banner_1?.image_url
      ? { original_url: data?.content?.product_banner?.post_banner?.banner_1?.image_url }
      : "",
    productBanner2Image: data?.content?.product_banner?.post_banner?.banner_2?.image_url
      ? { original_url: data?.content?.product_banner?.post_banner?.banner_2?.image_url }
      : "",
    offerBanner1Image1: data?.content?.offer_banner_1?.banner_1?.image_url
      ? { original_url: data?.content?.offer_banner_1?.banner_1?.image_url }
      : "",
    offerBanner1Image2: data?.content?.offer_banner_1?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner_1?.banner_2?.image_url }
      : "",
    offerBanner1Image3: data?.content?.offer_banner_1?.banner_3?.image_url
      ? { original_url: data?.content?.offer_banner_1?.banner_3?.image_url }
      : "",
    offerBanner2Image1: data?.content?.offer_banner_2?.banner_1?.image_url
      ? { original_url: data?.content?.offer_banner_2?.banner_1?.image_url }
      : "",
    offerBanner2Image2: data?.content?.offer_banner_2?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner_2?.banner_2?.image_url }
      : "",
    homeBannerImage: data?.content?.home_banner?.image_url
      ? { original_url: data?.content?.home_banner?.image_url }
      : "",
    ...
    productBanner1LinkType:
      data?.content?.product_banner?.post_banner?.banner_1?.redirect_link?.link_type || "",
    productBanner1Link:
      data?.content?.product_banner?.post_banner?.banner_1?.redirect_link?.link || "",

    productBanner2LinkType:
      data?.content?.product_banner?.post_banner?.banner_2?.redirect_link?.link_type || "",
    productBanner2Link:
      data?.content?.product_banner?.post_banner?.banner_2?.redirect_link?.link || "",
