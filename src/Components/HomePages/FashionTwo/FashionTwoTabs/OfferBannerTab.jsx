  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle
        ...
        titleList={FashionTwoFeatureBannerTitle}
      />
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="4">
          <FileUploadField
            paramsProps={{ mime_type: mediaConfig.image.join(",") }}
            name="offerBanner4Image"
            title="Image"
            id="offerBanner4Image"
            showImage={values["offerBanner4Image"]}
            type="file"
            values={values}
            setFieldValue={setFieldValue}
            helpertext={getHelperText("806x670px")}
          ...
          <CommonRedirect
            ...
            categoryData={categoryData}
            nameList={{
              selectNameKey: "offerBanner4LinkType",
              multipleNameKey: "offerBanner4Link",
            }}
            setSearch={setSearch}
          />
