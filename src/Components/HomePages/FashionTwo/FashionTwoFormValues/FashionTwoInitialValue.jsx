const FashionTwoInitialValue = (data) => {
  ...
  return {
    ...
    offerBanner2Image: data?.content?.offer_banner?.banner_2?.image_url
      ...
      : "",
    offerBanner3Image: data?.content?.offer_banner?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_3?.image_url }
      : "",
    offerBanner4Image: data?.content?.offer_banner?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_4?.image_url }
      : "",
    fullBannerImage: data?.content?.full_banner?.image_url
      ? { original_url: data?.content?.full_banner?.image_url }
      : "",
