const FashionSixInitialValue = (data) => {
  ...
  return {
    ...
    slug: data?.slug,
    // Images
    banner1Image: data?.content?.offer_banner?.banner_1?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_1?.image_url }
      : "",
    banner2Image: data?.content?.offer_banner?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_2?.image_url }
      : "",
    banner3Image: data?.content?.offer_banner?.banner_3?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_3?.image_url }
      : "",
    banner4Image: data?.content?.offer_banner?.banner_4?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_4?.image_url }
      : "",
    banner5Image: data?.content?.offer_banner?.banner_5?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_5?.image_url }
      : "",
    banner6Image: data?.content?.offer_banner?.banner_6?.image_url
      ? { original_url: data?.content?.offer_banner?.banner_6?.image_url }
      : "",

    rightPanelImage: data?.content?.products_list_2?.right_panel?.image_url
      ? { original_url: data?.content?.product_list_2?.right_panel?.image_url }
      : "",

    sliderProductImage: data?.content?.product_banner?.image_url
      ? { original_url: data?.content?.product_banner?.image_url }
      : "",
    ...obj,
