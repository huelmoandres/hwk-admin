          ...
          <>
            <div className="rule-edit-form">
              <SimpleInputField
                nameList={[
                  {
                    name: "[content][slider_products][product_slider_1][title]",
              ...
              />
              <CheckBoxField
                name="[content][slider_products][product_slider_1][status]"
                title="Status"
              />
            </div>
          </>
          ...
          <>
            <div className="rule-edit-form">
              <SimpleInputField
                nameList={[
                  {
                    name: "[content][slider_products][product_slider_2][title]",
                    placeholder: t("EnterTitle"),
                    title: "Title",
                  },
                ]}
              ...
              />
              <CheckBoxField
                name="[content][slider_products][product_slider_2][status]"
                title="Status"
              />
            </div>
          </>
