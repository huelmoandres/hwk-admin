...
const ShoesHomePageSubmit = (values, mutate) => {
  ...
  if (values["aboutBanner1Image"]) {
    values["content"]["about_banner"]["collection_banner"]["banner_1"]["image_url"] =
      values["aboutBanner1Image"].original_url;
  } else values["content"]["about_banner"]["collection_banner"]["banner_1"]["image_url"] = "";

  if (values["aboutBanner2Image"]) {
    values["content"]["about_banner"]["collection_banner"]["banner_2"]["image_url"] =
      values["aboutBanner2Image"].original_url;
  ...
  if (values["aboutBanner1LinkType"]) {
    values["content"]["about_banner"]["collection_banner"]["banner_1"]["redirect_link"][
      "link_type"
    ] = values["aboutBanner1LinkType"];
  } else {
    values["content"]["about_banner"]["collection_banner"]["banner_1"]["redirect_link"][
      "link_type"
    ] = "";
  ...
  if (values["aboutBanner2LinkType"]) {
    values["content"]["about_banner"]["collection_banner"]["banner_2"]["redirect_link"][
      "link_type"
    ] = values["aboutBanner2LinkType"];
  } else {
    values["content"]["about_banner"]["collection_banner"]["banner_2"]["redirect_link"][
      "link_type"
    ] = "";
