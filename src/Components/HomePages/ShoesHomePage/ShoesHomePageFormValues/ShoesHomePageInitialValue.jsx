const ShoesHomePageInitialValue = (data) => {
  ...
  return {
    ...
    slug: data?.slug,
    // Images
    aboutBanner1Image: data?.content?.about_banner?.collection_banner?.banner_1?.image_url
      ? { original_url: data?.content?.about_banner?.collection_banner?.banner_1?.image_url }
      : "",
    aboutBanner2Image: data?.content?.about_banner?.collection_banner?.banner_2?.image_url
      ? { original_url: data?.content?.about_banner?.collection_banner?.banner_2?.image_url }
      : "",
    ...obj,

    // Redirect Link
    aboutBanner1LinkType:
      data?.content?.about_banner?.collection_banner?.banner_1?.redirect_link?.link_type || "",
    aboutBanner1Link:
      data?.content?.about_banner?.collection_banner?.banner_1?.redirect_link?.link || "",

    aboutBanner2LinkType:
      data?.content?.about_banner?.collection_banner?.banner_2?.redirect_link?.link_type || "",
    aboutBanner2Link:
      data?.content?.about_banner?.collection_banner?.banner_2?.redirect_link?.link || "",
