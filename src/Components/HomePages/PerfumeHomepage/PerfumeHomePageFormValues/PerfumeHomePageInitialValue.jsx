const PerfumeHomePageInitialValue = (data) => {
  ...
  return {
    ...
    productListLeftPanelLinkType:
      data?.content?.product_list?.left_panel?.redirect_link?.link_type || "",
    ...
    homeBannerImage: data?.content?.home_banner?.image_url
      ...
      : "",
    collectionBannerImage: data?.content?.collection_banner?.image_url
      ? { original_url: data?.content?.collection_banner?.image_url }
      : "",
