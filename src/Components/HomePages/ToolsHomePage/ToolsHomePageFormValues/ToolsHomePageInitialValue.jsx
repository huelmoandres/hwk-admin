const ToolsHomePageInitialValue = (data) => {
  ...
  return {
    ...
    productList2Image: data?.content?.products_list_2?.image_url
      ? { original_url: data?.content?.product_list_2?.image_url }
      : "",
    categoryRightContentImage: data?.content?.category_product?.right_panel?.product_banner
      ?.image_url
