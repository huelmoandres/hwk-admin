  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle
        ...
        titleList={WatchOfferBanner2Title}
      />
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="3">
          <FileUploadField
            paramsProps={{ mime_type: mediaConfig.image.join(",") }}
            name="offerBanner2Image3"
            title="Image"
            id="offerBanner2Image3"
            showImage={values["offerBanner2Image3"]}
            type="file"
            values={values}
            setFieldValue={setFieldValue}
            helpertext={getHelperText("806x670px")}
          ...
          <CommonRedirect
            ...
            categoryData={categoryData}
            nameList={{
              selectNameKey: "offerBanner2LinkType3",
              multipleNameKey: "offerBanner2Link3",
            }}
            setSearch={setSearch}
          />
