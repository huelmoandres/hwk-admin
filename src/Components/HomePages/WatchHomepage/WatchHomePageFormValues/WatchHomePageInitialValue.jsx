const WatchHomePageInitialValue = (data) => {
  ...
  return {
    ...
    // Image
    offerBanner1Image: data?.content?.offer_banner_1?.image_url
    ...
    offerBanner2Image2: data?.content?.offer_banner_2?.banner_2?.image_url
      ...
      : "",
    offerBanner2Image3: data?.content?.offer_banner_2?.banner_3?.image_url
      ? { original_url: data?.content?.offer_banner_2?.banner_3?.image_url }
      : "",
    //MultiSelect
