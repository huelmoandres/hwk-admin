  ...
  return (
    <div className="inside-horizontal-tabs">
      ...
      <TabTitle
        ...
        titleList={FashionSevenProductList2Title}
      />
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          ...
          />
          <CheckBoxField
            name={`[content][products_list_2][left_panel][more_button]`}
            title="More Button"
          />
          {buttonText && (
            <SimpleInputField
          ...
          <CommonRedirect
            ...
            nameList={{ selectNameKey: "leftPanelLinkType", multipleNameKey: "leftPanelLink" }}
            setSearch={setSearch}
          />
        </TabPane>
        <TabPane tabId="2">
