const FashionSevenInitialValue = (data) => {
  ...
  return {
    ...
    banner1Image: data?.content?.featured_banners?.banner_1?.image_url
      ? { original_url: data?.content?.featured_banners?.banner_1?.image_url }
      : "",
    banner2Image: data?.content?.featured_banners?.banner_2?.image_url
      ? { original_url: data?.content?.featured_banners?.banner_2?.image_url }
      : "",
    banner3Image: data?.content?.featured_banners?.banner_3?.image_url
      ? { original_url: data?.content?.featured_banners?.banner_3?.image_url }
      : "",

    productBannerImage: data?.content?.product_banner?.image_url
