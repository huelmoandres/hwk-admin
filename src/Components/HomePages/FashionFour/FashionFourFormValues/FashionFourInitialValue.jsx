const FashionFourInitialValue = (data) => {
  ...
  return {
    ...
    //Images
    offerBanner2Image1: data?.content?.offer_banner_2?.image_url
      ? { original_url: data?.content?.offer_banner_2?.image_url } || ""
      : "",
    offerBanner1Image: data?.content?.offer_banner_1?.banner_1?.image_url
      ? { original_url: data?.content?.offer_banner_1?.banner_1?.image_url }
      : "",
    offerBanner2Image: data?.content?.offer_banner_1?.banner_2?.image_url
      ? { original_url: data?.content?.offer_banner_1?.banner_2?.image_url }
      : "",
    offerBanner3Image: data?.content?.offer_banner_1?.banner_2?.image_url
